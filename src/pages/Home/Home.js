...
import ExpenseForm from "../../component/Forms/ExpenseForm/ExpenseForm";
import Modal from "../../component/Modal/Modal";
import AddBalanceForm from "../../component/Forms/AddBalancaForm/AddBalanceForm";
...
export default function Home() {
  ...
  // for saving local storage expense list 
  useEffect(() => {
  ...
  // for saving balance in localstorage
  useEffect(() => {
    if (isMounted) {
